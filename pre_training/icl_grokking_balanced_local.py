...
class EvalDataset(Dataset):
    ...
    def __len__(self):
        return self.bs * self.n_point_per_row * (self.args.n_val_step + 1) # To ensure we don't have to restart dataloader.
...
def main(args):
    ...
    data_prefix = f"../data/mixed_noembd{args.dont_decay_embd}_parale{args.parallelogram}_pltask{args.n_tasks_pl}"
